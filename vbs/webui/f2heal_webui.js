...
async function applyPresetValues(preset) {
    ...
    bleInstance.setMessageBool(MESSAGE_TYPE_TEST_MODE, preset.testmode);await sleep(150);
    bleInstance.setMessageUInt32(MESSAGE_TYPE_SINGLE_CHANNEL, preset.single_channel);await sleep(150);
    ...
    document.getElementById('s_test_mode').checked = preset.testmode;
    document.getElementById('s_single_channel').value = preset.single_channel;
}
